...
const cardData: CardData[] = [
  {
    id: 1,
    imageUrl:
      "https://drive.google.com/file/d/1eUQo70HtjxUAfjJksWWqm0Fc9ojlUFAs/preview?usp=sharing",
    title: "Learn Kannada",
  },
  {
    id: 2,
...
export default function Carousel() {
  ...
  return (
    <section className="w-full flex-col items-center justify-center font-sans overflow-hidden">
      ...
      >
        <div className="relative flex w-full flex-col p-4 pt-6 md:p-6">
          <Badge className="absolute ml-[250px] top-[-15px] rounded-xl border border-gray-300 dark:border-white/10 text-base text-gray-700 dark:text-white/80 bg-gray-100/80 dark:bg-black/20 backdrop-blur-sm md:left-6">
    ...
    >
      <div className="relative w-full h-full rounded-3xl shadow-2xl overflow-hidden bg-gray-200 dark:bg-neutral-800">
        <iframe
          src={card.imageUrl}
          id={card.title}
          className="w-full h-full object-cover overflow-hidden pointer-events-none"
          onError={(e) => {
